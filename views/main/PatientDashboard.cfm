  ...
  <div style="text-align: right; margin-top: 20px;">
    ...
    <section class="bg-light py-3 py-md-5 py-xl-8">
        <div style="display: flex; justify-content: center; align-items: center;">
            <img src="#prc.profile_img#" alt="Profile Icon" style="width: 100px; height: 100px; border-radius: 50%;">
        </div>
        <div class="container">
        ...
        <a class="btn btn-warning" href="Main/appointment" role="button">Book Appointment</a>
    </div>
        <div class="container ">
            <div class="col-12">
