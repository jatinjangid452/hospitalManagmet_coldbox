            ...
            <tbody>
                <cfloop query="getPatients">
                    <tr>
                        ...
                        <td>
                            <!-- Edit Button -->
                            <a href="Main/Patinetdetails?action=edit&id=#p_id#" class="btn btn-edit">Edit</a>
                            <!--- <cflocation url="patient_details.cfm"> --->
                            <!-- Delete Button -->
                            <a href="Main/Patinetdetails?action=delete&id=#p_id#" class="btn btn-delete" onclick="return confirm('Are you sure you want to delete this patient?');">Delete</a>
                            <!--- <cflocation url="patient_details.cfm"> --->
                        </td>
                    </tr>
                </cfloop>
