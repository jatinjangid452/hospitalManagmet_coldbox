                    ...
                    <div class="col-lg-8 col-xl-6">
                        <div class="card rounded-3">
                            <div class="card-body p-4 p-md-5">
                                ...
                                <a href="Main/doctorManagement?doctor_id=0" class="button add-button">Add New Doctor</a>  
                                ...
                                <table class="doctor-table">
                                    ...
                                    <tr>
                                        ...
                                        <td class="action-links">
                                            <a href="Main/doctorManagement?doctor_id=#doctor_id#" class="button edit-button">Edit</a>
                                            <a href="Main/doctorManagement?delete_id=#doctor_id#" class="button delete-button">Delete</a>
                                        </td>
                                ...
                                <cfif structKeyExists(url, 'doctor_id')>
                                    ...
                                    <cfform name="doctorForm" method="POST" action="Main/doctorManagement">
